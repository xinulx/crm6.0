...
/**
* Override this method to implement a custom service
*/
...
AjaxAnywhere.prototype.onSubmitAjaxNotSupported = function (additionalPostData, submitButton) {
    ...
    if (typeof additionalPostData != 'undefined' && additionalPostData != null) {
        ...
        // date by altering form service URL.
...
*/
createAjaxInstance = function(key) {
    var ajaxAnywhere1 = new AjaxAnywhere();
	ajaxAnywhere1.id=key
	ajaxAnywhere1.bindById();
    return ajaxAnywhere1;
};
